...
th {
  ...
  <body class="hold-transition skin-purple layout-top-nav" style="background-position: center;" onload="myFunction()">
    <div class="wrapper">
	      ...
	      <div class="col-md-12">
              <div class="box box-warning" >
               ...
               <form method="post" id="reg-form">
                <div class="box-body">
				<div class="row">
					<div class="col-md-6" style="float: center; width: 90%; ">
