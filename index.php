...
<header>
<img src="img/BU LOGO.png" id="logo" style="float: left; max-width:125%; max-height: 125%; padding-left: 20px;">

<img src="img/BUCM-LOGO.png" id="logo" style="float: left; max-width:125%; max-height: 100%;">

    <h1 style="float: left; padding-left: 15px;">Bicol University College of Medicine</h1>
</header>
</div>
